...
var stickyAdjust = document.getElementById("processInfo_content_box_wrapper_id");

var sticky = 261;
var stickyUpperLimit = 4113;
var threshold = 100;
...
function myFunction() {
  ...
  if (window.pageYOffset >= sticky && window.pageYOffset <= stickyUpperLimit) {
    ...
    stickyAdjust.style.marginTop = "171.750px";

  } else {
    discoverStages.classList.remove("sticky");
    stickyAdjust.style.marginTop = "0px";
  }
  if (featuresDiv <= 10) {
    discoverStages.classList.remove("sticky");
  }
